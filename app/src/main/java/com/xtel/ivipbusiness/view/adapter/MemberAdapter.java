...
public class MemberAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            WidgetHelper.getInstance().setTextViewNoResult(viewHolder.txt_total_money, _view.getActivity().getString(R.string.total_money), (member.getTotal_money().intValue() + " đ"));
            WidgetHelper.getInstance().setTextViewNoResult(viewHolder.txt_shopping_in_store, _view.getActivity().getString(R.string.total_shopping_in_store), String.valueOf(member.getBuy_number().intValue()));
